...
import { createExaminationOrder, createFollowUpPathologyOrder, type ExaminationOrderRequest, type ExaminationOrderType } from "../../_lib/respiratory-api";
...
export function StageExaminationOrder({ caseId, orderType, onCreated, followUpPathologyOrder = false, triggerLabel }: { caseId: string; orderType: ExaminationOrderType; onCreated?: (orderType: ExaminationOrderType) => void; followUpPathologyOrder?: boolean; triggerLabel?: string }) {
  ...
  const submit = async () => {
    ...
    try {
      if (followUpPathologyOrder) {
        await createFollowUpPathologyOrder(authorizedFetch, caseId, {
