...
class DoctorFollowUpPathologyOrderAPITests(TestCase):
    def setUp(self):
        ...
        self.subtype_order = ExaminationOrder.objects.create(
            case=self.case, order_type=ExaminationOrder.OrderType.PATHOLOGY_GENE,
    ...
    def confirm_subtype(self):
        return ClinicalResult.objects.create(
            case=self.case, examination_order=self.subtype_order, workflow_stage=WorkflowStage.PATHOLOGY_GENE,
    ...
    def test_rejects_pdl1_before_confirmed_pathology_gene_result(self):
    ...
    def test_creates_order_and_initial_work_item_atomically(self):
        ...
        self.assertEqual(order.order_type, ExaminationOrder.OrderType.PDL1)
