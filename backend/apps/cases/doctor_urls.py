...
from .views import (
    ...
    DoctorSubmittedPathologyResultConfirmAPIView,
...
urlpatterns = [
    ...
    path(
        "<uuid:case_id>/clinical-results/pathology/<uuid:result_id>/confirm/",
        DoctorSubmittedPathologyResultConfirmAPIView.as_view(),
        name="doctor-submitted-pathology-result-confirm",
    ),
