...
from .views import (
    ...
    DoctorCaseCtSegmentationAPIView,
...
urlpatterns = [
    ...
    path("<uuid:case_id>/ct-analyses/<uuid:analysis_id>/segmentation/", DoctorCaseCtSegmentationAPIView.as_view(), name="doctor-case-ct-segmentation"),
    path("<uuid:case_id>/ct-analyses/<uuid:analysis_id>/segmentation/labelmap/", DoctorCaseCtSegmentationLabelmapAPIView.as_view(), name="doctor-case-ct-segmentation-labelmap"),
    path("<uuid:case_id>/ct-analyses/<uuid:analysis_id>/visualization/", DoctorCaseCtVisualizationAPIView.as_view(), name="doctor-case-ct-visualization"),
    path("<uuid:case_id>/ct-analyses/<uuid:analysis_id>/visualization/<slug:layer_id>/", DoctorCaseCtVisualizationAPIView.as_view(), name="doctor-case-ct-visualization-layer"),
    path(
    ...
    path(
        ...
        name="doctor-examination-order-detail",
    ),
    path(
    ...
    path(
        "<uuid:case_id>/prescriptions/<uuid:prescription_id>/medication-schedules/",
        DoctorMedicationScheduleListCreateAPIView.as_view(),
        name="doctor-medication-schedule-list-create",
    ),
    path(
        "<uuid:case_id>/prescriptions/<uuid:prescription_id>/medication-schedules/<uuid:schedule_id>/",
        DoctorMedicationScheduleDetailAPIView.as_view(),
        name="doctor-medication-schedule-detail",
    ),
    path(
