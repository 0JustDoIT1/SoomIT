...
# Inference-only logging configuration.
# Avoid importing scripts.train, which pulls training/data dependencies
# that are unnecessary in the Cloud Run serving image.
CONFIG = {
    "version": 1,
